	...
	<table style="text-align: center;">
		...
		<tr>
			...
			<c:forEach items="${memberList}" var="dto">
				...
				<form action="updateMemberinfo" onsubmit="return formCheck(this)">
					<td>
						...
						<div class="meminfo">
							...
							<input type="text" style="display: none;" id="pcrCode"
								...
								type="text" style="display: none;" id="memId" name="memId"
								value="${dto.memId }">

							<div style="display: flex;">

								<input type="text" id="memPw" name="memPw" value="${dto.memPw }">
							</div>
							<div style="display: flex;">
							...
							<div style="display: flex;">
								...
								<input type="text" id="memHp" name="memHp" value="${dto.memHp }">
							</div>
							<div style="display: flex;">

								<input type="text" id="memEmail " name="memEmail" value="${dto.memEmail}">
							</div>
							<div style="display: flex;">

								<input type="text" id="memAge" name="memAge"
									value="${dto.memAge }">
							</div>
							<div style="display: flex;">
