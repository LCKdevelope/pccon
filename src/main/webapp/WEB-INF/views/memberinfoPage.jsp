	...
	<main class="form-signin w-100 m-auto">
		<form action="updateMemberInfo" method="post"
			...
			<div class="form-floating">
				<input  type="text" style="display: none;" class="form-control memId" value="${pcrMemberinfo.memId }" id="floatingInput memId" name="memId" placeholder="아이디"> 
				<div >${pcrMemberinfo.memId }</div> 
			...
			<div class="form-floating">
				<input type="text" class="form-control" id="floatingInput memName" value="${pcrMemberinfo.memName }"
					name="memName" placeholder="이름"> <label for="floatingInput">${pcrMemberinfo.memName }</label>
				<span id="nameCheckMsg"></span>
			</div>

			<div class="form-floating">
				<input type="text" class="form-control" id="floatingInput memEmail" value="${pcrMemberinfo.memEmail }"
					 name="memEmail" placeholder="이메일"> <label
					for="floatingInput">${pcrMemberinfo.memEmail }</label> <span id="emailCheckMsg"></span>
			</div>

			<div class="form-floating">
				<input type="text" class="form-control" id="floatingInput memHp" value="${pcrMemberinfo.memHp }"
					name="memHp" placeholder="전화번호"> <label for="floatingInput">${pcrMemberinfo.memHp }</label>
				<span id="hpCheckMsg"></span>
			</div>

			<div class="form-floating">
				<input type="text" class="form-control" id="floatingInput memAge" value="${pcrMemberinfo.memAge }"
					name="memAge" placeholder="나이"> <label for="floatingInput">${pcrMemberinfo.memAge }</label>
				<span id="ageCheckMsg"></span>
			</div>
			<div class="form-floating" style="display: none;">
				<input type="text" value="${pcrCode}" class="form-control"
